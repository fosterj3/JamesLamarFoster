---
title: "Washington state Department of Education COVID-19 Communication"
author: "Foster, J.L."
date: '2019-05-07T00:00:00Z'
summary: Visualization of OSPI COVID Communication
tags:
- Visualization
- COVID-19
image:
  ...
  focal_point: Smart
---
In this project, I made two timelines with the same data using two different timline packages - timevis and vistime. On this website I only show the vistime timeline due to compatability issues. 
```{r, message = F}
library(tidyverse)
library(timevis)
library(vistime)
